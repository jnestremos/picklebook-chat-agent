...
export function buildSystemPrompt(): string {
  ...
  return [
    ...
    ``,
    `LANGUAGE (mandatory): Write every reply in English only. Never use Chinese, Tagalog, or any other language — including in parentheses, counts, or closing notes.`,
    ``,
    ...
    ``,
    `Behaviour:`,
    `  • Keep venue names verbatim from the database.`,
